...
The current implementation covers `corex-001` through `corex-005`, `runwf-001` through `runwf-004`, `gates-001` through `gates-005`, `packg-001` through `packg-004`, `pilot-001` through `pilot-005`, `align-001` through `align-008`, `graph-001` through `graph-012`, `token-001`/`token-002`, MAR evidence, policy-promotion evidence, DESIGN-004/DESIGN-005 design-evidence schema/artifact/gate support, GAJAE-002 source-side GJC evidence wrapper MVP, GAJAE-003 packet-ref/artifact-ref validation, and GAJAE-004 source-side ralplan/callback evidence pilot support. GAJAE source work does not authorize install/release/runtime activation by itself.
