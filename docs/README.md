...
- GAJAE helper companion planning lives in `docs/sot/gajae-gjc-wrapper-evidence.md`; KAH wraps GJC execution, preserves GJC/KAT artifact refs and hashes, exposes async/callback status, and stays out of KAS plan/review/MAR/final authority. GAJAE-001..006 completed source-side closeout; GAJAE-007..010 are planned real-pilot unblock tasks for native GJC 0.7.3 adapters, KAT evidence normalization, and contract docs/skill updates.
